...
function StateModal({ data, onClose }) {
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-lg w-96 h-[32rem] overflow-hidden fixed-modal flex flex-col">
        <div className="p-4 flex justify-between items-center border-b">
          <h3 className="text-lg font-medium text-black">Current Application State</h3>
          <button
            onClick={handleCopy}
        ...
        <div className="flex-grow overflow-y-auto p-4" ref={contentRef}>
          <pre className="text-black whitespace-pre-wrap">{JSON.stringify(data, null, 2)}</pre>
        </div>
        <div className="bg-gray-100 px-4 py-3 flex justify-end border-t">
          <button
            onClick={onClose}
